...
implicit none
double precision a(0:), b(0:), c(0:), d(0:mpnw+6), db
...
implicit none
double precision a(0:), b(0:), s0(0:mpnw+5)
...
double precision a(0:), b(0:), c(0:), d(0:mpnw+5)
...
double precision a1, a2, b, bb, b1, b2, br, c1, c2, dc, dd, d1, d2, rb, &
  t0, t1
double precision a(0:), c(0:), d(0:mpnw+5)
...
implicit none
integer mpnw
double precision a(0:), b, c(0:), t1, t2
...
double precision a(0:), b(0:), s0(0:mpnw+5), s1(0:mpnw+5)
...
implicit none
integer i, nb, mpnw
double precision a(0:), b(0:), c(0:), s(0:mpnw+5)
...
double precision a(0:), b(0:), c(0:), d(0:mpnw+7), &
