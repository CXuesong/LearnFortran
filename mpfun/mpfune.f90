...
double precision dasy, anu(0:), anumx, t(0:), z(0:), &
...
double precision t(0:), z(0:), f1(0:8), sum1(0:mpnw+6), &
...
double precision g(0:), s(0:), t0(0:mpnw+6), t1(0:mpnw+6), &
...
double precision s(0:mpnw+6), ss(0:), zz(0:), &
...
double precision s(0:), z(0:), t0(0:mpnw+6), t1(0:mpnw+6), &
  t2(0:mpnw+6), t3(0:mpnw+6), t4(0:mpnw+6), t5(0:mpnw+6), t6(0:mpnw+6), &
