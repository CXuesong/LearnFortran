...
parameter (itrmx = 50)
double precision a(0:), b(0:), c(0:), s0(0:mpnw+6), &
...
double precision a(0:), x(0:), y(0:), s0(0:mpnw+6), &
...
implicit none
integer i, mpnw, mp7
double precision a(0:), x(0:), y(0:), s0(0:2*mpnw+13), &
  s1(0:2*mpnw+13)
...
parameter (mpnwx = 300)
double precision a(0:), b(0:), s0(0:mpnw+6), &
...
double precision a(0:), b(0:), s0(0:2*mpnw+13), &
...
double precision a(0:), b(0:), f1(0:18), f4(0:18), &
  s0(0:2*mpnw+13), s1(0:2*mpnw+13), s2(0:2*mpnw+13), s3(0:2*mpnw+13), &
  s4(0:2*mpnw+13)
...
double precision a(0:), f(0:9), x(0:), y(0:), s0(0:mpnw+6), &
...
double precision a(0:), f1(0:8), f2(0:8), x(0:), y(0:), &
...
implicit none
integer mp7, mpnw
double precision a(0:), f(0:8), x(0:), y(0:), &
...
parameter (itrmx = 1000000, mpnwx = 700)
double precision a(0:), b(0:), f(0:8), s0(0:mpnw+6), &
  s1(0:mpnw+6), s2(0:mpnw+6), s3(0:mpnw+6), s4(0:mpnw+6)
...
parameter (cl2 = 1.4426950408889633d0, nit = 3, mprxx = 1d-14)
double precision a(0:), b(0:), s0(0:mpnw+6), s1(0:mpnw+6), &
...
double precision a(0:), b(0:), f1(0:8), s0(0:mpnw+6), &
  s1(0:mpnw+6), s2(0:mpnw+6), s3(0:mpnw+6), s4(0:mpnw+6)
...
double precision st, rtol, tol, t1, t2, tn
parameter (itrmax = 1000000, rtol = 0.5d0**7)
double precision a(0:), b(0:), f1(0:8), f4(0:8), s0(0:mpnw+6), &
  s1(0:mpnw+6), s2(0:mpnw+6), s3(0:mpnw+6), s4(0:mpnw+6)
...
double precision alog2(0:), f1(0:8), f4(0:8), pi(0:), &
  s0(0:mpnw+6), s1(0:mpnw+6), s2(0:mpnw+6), s3(0:mpnw+6), s4(0:mpnw+6)
...
double precision pi(0:), s0(0:mpnw+6), s1(0:mpnw+6), s2(0:mpnw+6), &
